...
export const userSchemaGeneric =  z.object({
  ...
  // export const userLoginSchema = userSchemaGeneric.pick({email: true, password: true})

  export const loginUserSchema = z.object({
    body: userSchemaGeneric.pick({email: true, password: true})
  });

  // const userGoogleLoginSchema = userSchemaGeneric.pick({username: true,email: true, avatar: true});
